...
class Evaluator:
    ...
    def __init__(self, dataset, rankings,doTopN:bool):
        ed = EvaluationData(dataset, rankings,doTopN)
        self.dataset = ed
        self.doTopN=doTopN
    ...
    def Evaluate(self):
        ...
        for algorithm in self.algorithms:
            ...
            results[algorithm.GetName()] = algorithm.Evaluate(self.dataset, self.doTopN)
